...
**Last verified against the real codebase:** 2026-09-17, after PRs #9–#24 (multi-tenant subsystem activation, scheduled certification, versioned policy/certification history, diagnostics/health/metrics CLI commands) plus this pass's `ResourceGraph` closure. Everything below reflects actual importers/callers checked directly, not file existence. Where a status changed, the entry says what changed it and how it was verified.
